...
public class Drive extends Command {
  ...
  protected void execute() {
    ...
    double strafe;
    double turn;
    if (SmartDashboard.getBoolean("Cheesy", false)) {
    ...
    if (SmartDashboard.getBoolean("Kiddie Mode", false)) {
      throttle *= SmartDashboard.getNumber("power", 0.2);
    }

    Robot.driveTrain.setSpeeds(throttle * forward, SmartDashboard.getNumber("Turn Factor", .75) * throttle * turn,
        throttle * strafe);
