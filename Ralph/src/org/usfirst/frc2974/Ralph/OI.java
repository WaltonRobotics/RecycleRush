...
import org.usfirst.frc2974.Ralph.autonomous.AutonomousCommand;
...
public class OI {
    ...
    public OI() {
	    ...
	    SmartDashboard.putData( "Test Stuff(aka the old autonCommand)", new TestStuff());
	    SmartDashboard.putData("UpDownTeleop", new UpDownTeleop());
	    SmartDashboard.putData(new Grab());
        
        // end SmartDashboard buttons
